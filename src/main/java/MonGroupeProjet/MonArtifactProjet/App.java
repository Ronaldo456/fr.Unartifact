...
public class App {
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		String texteInitial2 = "L'histoire de Rome s'étend sur plus de vingt-huit siècles, depuis sa fondation mythique par Romulus en 753 av. J.-C. jusqu'à "
		...
		// File f = new File("C:\\Users\\Soufiane
		// ACHOUR\\Documents\\Projets_Java\\MonArtifactProjet\\texteApplication.txt");
		// FileReader f_reader;
		// try {
